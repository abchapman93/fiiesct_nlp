...
def get_asserted(span, exclusion_attrs=("is_negated", "is_historical",
                                        # "is_uncertain",
                                        "is_hypothetical",
                                        "is_family", "is_ignored",
                                        "is_seeking",
                                        )):
...
_span_extensions = {
    ...
    "is_seeking": {"default": False},
    "is_enrolled": {"default": False},
    "is_need": {"default": False},
